...
SDL_DYNAPI_PROC(bool,SDL_SetRenderTextureBorderColor,(SDL_Renderer *a,SDL_TextureBorderColor b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_GetRenderTextureBorderColor,(SDL_Renderer *a,SDL_TextureBorderColor *b),(a,b),return)
