...
static SDL_TextureAddressMode u_mode = SDL_TEXTURE_ADDRESS_AUTO;
static SDL_TextureAddressMode v_mode = SDL_TEXTURE_ADDRESS_BORDER;
static SDL_TextureBorderColor border_color = SDL_TEXTURE_BORDER_COLOR_OPAQUE_WHITE;
static int done;
...
{
    const int border_color_count = SDL_TEXTURE_BORDER_COLOR_TRANSPARENT_BLACK + 1;
    const int texture_address_count = SDL_TEXTURE_ADDRESS_BORDER + 1;
    int i;
    SDL_Event event;
